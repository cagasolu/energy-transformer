...
energetic_mahal_science.py
     ...
     GLOBAL eba: global Energy Based Attention
         ...
         Mahalanobis Distance requires pretrained weights from:
            - pretrain_selyne_recon.py  (model initialization)

        One-dimensional version of globaleba_mahalanobis.py:
            - globaleba_mahalanobis.py  (energy-based calculations methodology)

        Usage: python or python3 energetic_mahal_science.py --data_root ./data/brisc2025
...
def load_dataset_for_anomaly(data_root="./data/brisc2025/brisc2025/classification_task", diff_samples=10000):
    ...
    def load_images_from_dir(directory, transform_fn, max_samples=None):
        images_all = []
    ...
    if os.path.exists(train_path):
        ...
        if os.path.exists(normal_train_path):
            train_normal_images = load_images_from_dir(normal_train_path, transform)
            ...
            for subdir in os.listdir(train_path):
                ...
                if os.path.isdir(subdir_path):
                    images_all_v2 = load_images_from_dir(subdir_path, transform)
                    if images_all_v2:
    ...
    if os.path.exists(test_path):
        ...
        for class_name in os.listdir(test_path):
            ...
            if os.path.isdir(class_path):
                images_all_v2 = load_images_from_dir(class_path, transform)
...
if __name__ == "__main__":
    ...
    # Load Brain Tumor MRI dataset (single class)
    ...
    model = train_mahalanobis_enhanced(model, train_loader, DEVICE, epochs=10, lr=1e-5)
