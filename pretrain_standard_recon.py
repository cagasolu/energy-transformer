...
def plot_professional_graphs(
    ...
    PLOTS_DIR = "pre_training_plots_second"
...
if __name__ == "__main__":
    ...
    for ep in range(EPOCHS):
        ...
        if val_acc > best_acc:
            ...
            torch.save(model.state_dict(), "pretrained_standard_full_recon_best.pt")
    ...
    torch.save(model.state_dict(), "pretrained_standard_full_recon.pt")
